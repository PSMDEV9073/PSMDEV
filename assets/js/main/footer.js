                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6 footer-social">
                            <a style="font-weight: 600;">SNS:</a>
                            <a href="${Web_Youtube}"><i class="fab fa-youtube"></i></a>
                            <a href="${Web_Discord}"><i class="fab fa-discord"></i></a>
                            <a href="${Web_Gihub}"><i class="fab fa-github"></i></a>
                        </div>
                    </div>
                </div>
            </div>
